  ...
  <span v-else>
    ...
    <div v-if="showModules">
      ...
      <div v-if="studentInfo.cohort" v-for="module in studentInfo.cohort.modules" :key="module.id" class="row pt-3 pb-3" style="border-bottom: 1px solid #ccc;">
        ...
        <div class="col-2 my-auto">
          <div class="card text-center">
            <div v-if="!module.student_modules[0] || !module.student_modules[0].approved_by" class="card-body">
              <p class="card-text">&nbsp;</p>
        ...
        <div class="col-2 my-auto">
          ...
          <div v-else class="card text-center">
            <div class="card-body">
              <p class="card-text">&nbsp;</p>
              <input v-on:click="beganModule(module.id, true)" :disabled="submittedBegin" type="checkbox" id="checkbox" :value="module.id">
              <label for="checkbox">Gestart?</label>
              <p class="card-text">&nbsp;</p>
            </div>
          </div>   
